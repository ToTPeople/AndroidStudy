...
public class NetDataLoadIntentService extends IntentService {
    ...
    private static final String ACTION_FOO = "com.example.lfs.androidstudy.ContentProviderLoad.action.FOO";
    private static final String ACTION_BAZ = "com.example.lfs.androidstudy.ContentProviderLoad.action.BAZ";

    // TODO: Rename parameters
    private static final String EXTRA_PARAM1 = "com.example.lfs.androidstudy.ContentProviderLoad.extra.PARAM1";
    private static final String EXTRA_PARAM2 = "com.example.lfs.androidstudy.ContentProviderLoad.extra.PARAM2";
    ...
    public static void startActionFoo(Context context, String param1, String param2) {
        Intent intent = new Intent(context, NetDataLoadIntentService.class);
